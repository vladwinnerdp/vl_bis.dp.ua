...
class jMail_acy extends PHPMailer
{
	...
	function &Send()
	{
		...
		{
			return acymailing_raiseError(E_NOTICE,  500, acymailing_translation('MAIL_FUNCTION_DISABLED') );
		}
	...
	function setSender($from)
	{
		...
		// If it is neither, we throw a warning
			...
			acymailing_raiseError(E_WARNING, 0, "JMail::  Invalid E-Mail Sender: $from", "JMail::setSender($from)");
		}
	}
