...
<form action="<?php echo JRoute::_('index.php?option=com_bis&view=events&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm">
    ...
    <?php else : ?>
        <table  class="table table-striped table-condensed" id="pageList">
            ...
            <?php foreach ($this->items as $i => $item): ?>
                <tr>
                    <td>
                        <a href="javascript:void(0)" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $item->id; ?>', '<?php echo $this->escape(addslashes($item->name)); ?>','<?php echo $this->escape('index.php?option=com_puzzles&amp;view=puzzles&amp;id='.$item->id); ?>', null);">
